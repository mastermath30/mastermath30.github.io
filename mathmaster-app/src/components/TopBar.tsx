					...
					<div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border border-white/20 dark:border-slate-700/50 rounded-full px-4 py-3 md:px-6 md:py-2 shadow-lg">
						<div className="flex items-center justify-between gap-4">
							...
							<div className="hidden md:block">
								<Link
									href="/auth"
									className={`relative font-medium px-6 py-2 rounded-full flex items-center transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer group ${
										pathname === "/auth"
					...
					>
						<div className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border border-white/20 dark:border-slate-700/50 rounded-2xl p-4 shadow-2xl">
							<div className="flex flex-col space-y-1">
								...
								<Link
									href="/auth"
									className={`relative bg-gradient-to-r from-violet-600 to-purple-500 text-white font-medium px-6 py-3 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer group transform ${
										isOpen ? "animate-mobile-menu-item" : ""
									}`}
									style={{
										animationDelay: isOpen
