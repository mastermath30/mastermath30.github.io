...
function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  return (
    <div className="testimonial-card rounded-2xl p-5 mb-4 border border-slate-200/50 dark:border-slate-700/50 shadow-sm hover:shadow-md transition-shadow">
...
export function TestimonialsScroll() {
  return (
    <div className="relative">
      ...
      <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-slate-900 to-transparent z-10 pointer-events-none" />
