  ...
  const renderCalendar = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      calendarDays.push(
        <div
          key={day}
          className={`h-12 flex flex-col items-center justify-center rounded-lg text-sm transition-all cursor-pointer hover:bg-violet-50 ${
            isToday ? "bg-gradient-to-br from-violet-500 to-purple-500 text-white font-semibold shadow-lg" : "text-slate-700 hover:text-violet-600"
          }`}
        >
          {day}
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-purple-900/95 via-purple-800/90 to-indigo-900/95" />
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 pb-32">
        ...
        <Card className="mb-8 overflow-hidden">
          <div className="flex items-center justify-between p-6 bg-gradient-to-r from-purple-50 to-indigo-50 border-b border-slate-100">
          ...
          <div className="p-6 border-b border-slate-100 bg-gradient-to-r from-green-50 to-emerald-50">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>Your scheduled study sessions and tutoring appointments</CardDescription>
              </div>
            </div>
          </div>
          <div className="divide-y divide-slate-100">
            {sessions.map((session) => (
              <div key={session.title} className="p-4 flex items-center gap-4 hover:bg-slate-50 transition-colors">
                <Image
                  src={session.image}
                  alt={session.tutor}
                  width={48}
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-slate-500 text-sm mt-1">Book a session with our expert peer tutors</p>
            </div>
            <Link href="#" className="text-violet-500 text-sm font-medium hover:underline">
              View all tutors
            </Link>
          </div>
            ...
            {tutors.map((tutor) => (
              <Card key={tutor.name} className="overflow-hidden" padding="none">
                ...
                <div className="p-5">
                  ...
                  <p className="text-slate-500 text-sm mb-3">{tutor.subjects}</p>
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <span className="ml-auto text-slate-500">
                      <span className="font-bold text-slate-900 text-lg">${tutor.price}</span>/hr
                    </span>
                  </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold text-slate-900">Open Study Groups</h2>
              <p className="text-slate-500 text-sm mt-1">Join collaborative learning sessions with other students</p>
            </div>
          </div>
